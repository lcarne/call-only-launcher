...
val md_theme_light_background = Color(0xFFF0F4F8) // Standardized light gray-blue background for contrast
...
val md_theme_dark_background = Color(0xFF0F1113) // Darker background for contrast
...
// Legacy / High Contrast mappings (can be mapped to new vars or kept for compatibility)
val White = Color(0xFFFFFFFF)
val Black = Color(0xFF000000)
val LightGray = Color(0xFFD3D3D3)
val PrimaryBlue = md_theme_light_primary
