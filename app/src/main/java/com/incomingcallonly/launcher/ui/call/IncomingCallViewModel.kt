...
class IncomingCallViewModel @Inject constructor(
    ...
    val incomingCallState = combine(
        ...
        if (number == null) {
            ...
            when (state) {
                com.incomingcallonly.launcher.manager.CallState.Idle,
                com.incomingcallonly.launcher.manager.CallState.Ended -> IncomingCallUiState.Empty

                com.incomingcallonly.launcher.manager.CallState.Active -> IncomingCallUiState.Active(
                    number,
                    contact
                )

                com.incomingcallonly.launcher.manager.CallState.Ringing -> IncomingCallUiState.Ringing(
                    number,
                    contact
                )
            }
